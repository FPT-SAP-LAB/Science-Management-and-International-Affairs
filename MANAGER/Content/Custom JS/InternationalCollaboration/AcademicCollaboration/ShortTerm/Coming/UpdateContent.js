$('#stc_describe_content').on('show.bs.modal', function () {
    getSTCContent();
});

var collab_type_direction_id;
function getSTCContent() {
    //get content
    $.ajax({
        ...
        data: {
            ...
            language_id: function () { return $('#stc_describe_content_language').val(); }
        },
        dataType: "json",
        success: function (data) {
            if (data != null) {
                if (data.success) {
                    ...
                    $('#stc_describe_content_description').val(data.obj.description);
                } else {
...
$('#stc_describe_content_language').select2({
...
$('#stc_describe_content_save').on('click', function () {
    $.ajax({
        ...
        data: {
            ...
            language_id: function () { return $('#stc_describe_content_language').val(); },
            description: function () { return $('#stc_describe_content_description').val(); }
        },
        dataType: "json",
        success: function (data) {
            if (data != null) {
