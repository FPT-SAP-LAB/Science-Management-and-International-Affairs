    ...
    var procedure_going_table = $('#procedure_going_table')
        .DataTable({
            ...
            columnDefs: [{
                    ...
                    width: '125px',
                    render: function(data) {
                        return '<a class="btn btn-sm btn-light-primary px-6" style="margin-right: 10px;" data-toggle="modal" onclick="' + data + '" href="#edit_procedure">Sửa</a><a href="#delete" class="btn btn-sm btn-light-danger px-6" onclick="' + data + '" data-toggle="modal">Xóa</a>'
                    }
                },
                {
                    targets: '_all',
