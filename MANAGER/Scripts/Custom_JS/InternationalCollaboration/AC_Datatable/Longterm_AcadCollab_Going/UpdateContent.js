$('#ltg_describe_content').on('show.bs.modal', function () {
    getLTGContent();
});
...
function getLTGContent() {
    ...
    $.ajax({
        ...
        data: {
            ...
            language_id: function () { return $('#ltg_describe_content_language').val(); }
        },
        dataType: "json",
        success: function (data) {
            if (data != null) {
                if (data.success) {
                    ...
                    $('#ltg_describe_content_description').val(data.obj.description);
                } else {
...
$('#ltg_describe_content_language').select2({
...
$('#ltg_describe_content_save').on('click', function () {
    $.ajax({
        ...
        data: {
            ...
            language_id: function () { return $('#ltg_describe_content_language').val(); },
            description: function () { return $('#ltg_describe_content_description').val(); }
        },
        dataType: "json",
        success: function (data) {
            if (data != null) {
